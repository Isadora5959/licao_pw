...
?>
            ...
            <dl class="dl-horizontal">
                ...
                <dt>CEP:</dt>
                <dd><?php echo formatacpf($customer['zip_code']); ?></dd>
            ...
            <dl class="dl-horizontal">
                ...
                <dt>Telefone:</dt>
                <dd><?php echo formacel($customer['phone']); ?></dd>

                <dt>Celular:</dt>
                <dd><?php echo formatel($customer['mobile']); ?></dd>
            ...
            <div id="actions" class="row">
                <div class="col-md-12">
                <a href="edit.php?id=<?php echo $customer['id']; ?>" class="btn btn-secondary"><i class="fa-solid fa-pen-to-square"></i></i>Editar</a>
