...
<html>
  ...
  <body>
      <nav class="navbar navbar-expand-lg bg-body-tertiary bg-dark border-bottom fixed-top border-body" data-bs-theme="dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="<?php echo BASEURL; ?>customers">Gerenciar Tema</a></li>
                <li><a class="dropdown-item" href="<?php echo BASEURL; ?>customers/add.php">Novo Tema</a></li>
              </ul>
            </li>
